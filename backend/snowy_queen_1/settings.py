"""
Django settings for snowy_queen_1 project.
...
ROOT_URLCONF = 'snowy_queen_1.urls'
...
WSGI_APPLICATION = 'snowy_queen_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Snowy Queen Support <support@snowy-queen-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "snowy_queen_1 API",
    "DESCRIPTION": "API documentation for snowy_queen_1 App",
    "VERSION": "v1",
}
